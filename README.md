...
Sure, here is the table with rows and columns transposed:

|      | 1주차          | 2주차          | 3주차            | 4주차          | 5주차          | 6주차               | 7주차                   | 8주차              | 9주차            | 10주차         | 11주차                                                        | 12주차  | 13주차      | 14주차~      |
|------|---------------|---------------|-----------------|---------------|---------------|--------------------|-------------------------|-------------------|-----------------|---------------|---------------------------------------------------------------|---------|-------------|-------------|
| 주제 | Python        | Pandas        | 공공데이터      | SQL           | 크롤링        | 통계&Numpy         | Machine Learning        | Deep Learning     | CV              | 자연어 처리    | 웹 기초                                                       | 웹 활용 | AWS 클라우드 | 기업 프로젝트 |
...
I left the 10th week's entry for "자연어 처리" empty as you didn't specify a logo for it. If you have a logo or specific information to add for it, please provide it, and I'll include it in the table.
